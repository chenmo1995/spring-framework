...
public class LogAspect {
	...
	//前置通知
	@Before("execution(* com.fudn.spring.aop.HelloService.sayHello(..))")
	...
	//返回通知
	@AfterReturning(value = "execution(* com.fudn.spring.aop.HelloService.sayHello(..))",returning = "result")
	...
	//后置通知
	@After("execution(* com.fudn.spring.aop.HelloService.sayHello(..))")
	...
	//异常
	@AfterThrowing(value = "execution(* com.fudn.spring.aop.HelloService.sayHello(..))",throwing = "e")
